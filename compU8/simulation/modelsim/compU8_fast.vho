...
ARCHITECTURE structure OF compU8 IS
...
-- Equation(s):
-- \Equal0~3_combout\ = (\b~combout\(7) & (\a~combout\(7) & (\a~combout\(6) $ (!\b~combout\(6))))) # (!\b~combout\(7) & (!\a~combout\(7) & (\a~combout\(6) $ (!\b~combout\(6)))))
